...
namespace LogisticsApp.Infrastructure.Migrations
{
    ...
    [Migration("20251028180325_QCItemAdded")]
    partial class QCItemAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogisticsApp.Domain.BoundedContexts.Catalog.Aggregates.DefectiveItemAggregate.DefectiveItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DefectiveItems", (string)null);
                });
            ...
            modelBuilder.Entity("LogisticsApp.Domain.BoundedContexts.Catalog.Aggregates.QCItemAggregate.QCItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LogisticsApp.Infrastructure.Persistence.Aggregates.Products.Entities.ProductEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LogisticsApp.Infrastructure.Persistence.Aggregates.Products.Entities.ProductEntity", b =>
                {
                    b.OwnsMany("LogisticsApp.Infrastructure.Persistence.Aggregates.Products.Entities.VariationEntity", "Variations", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ProductCategories", b =>
                {
                    ...
                    b.HasOne("LogisticsApp.Infrastructure.Persistence.Aggregates.Products.Entities.ProductEntity", null)
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
