...
namespace LogisticsApp.Infrastructure.Migrations
{
    ...
    [Migration("20251001182616_OrderReturnItemIdUpdated")]
    partial class OrderReturnItemIdUpdated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogisticsApp.Domain.BoundedContexts.Catalog.Aggregates.OrderReturn.OrderReturn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LogisticsApp.Domain.BoundedContexts.Catalog.Aggregates.OrderReturn.OrderReturn", b =>
                {
                    b.OwnsMany("LogisticsApp.Domain.BoundedContexts.Catalog.Aggregates.OrderReturn.ValueObjects.OrderReturnItem", "Items", b1 =>
                        {
                            ...
                            b1.HasKey("OrderReturnId", "Id");

                            b1.ToTable("OrderReturnItem");
