...
namespace LogisticsApp.Infrastructure.Migrations
{
    ...
    [Migration("20250930135429_OrderAggregateAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogisticsApp.Infrastructure.Persistence.Products.Entities.CategoryEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LogisticsApp.Infrastructure.Persistence.Products.Entities.ColorEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LogisticsApp.Infrastructure.Persistence.Products.Entities.SizeEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LogisticsApp.Domain.BoundedContexts.Catalog.Aggregates.Order.Order", b =>
                {
                    b.OwnsMany("LogisticsApp.Domain.BoundedContexts.Catalog.Aggregates.Order.ValueObjects.OrderItem", "Items", b1 =>
                        {
            ...
            modelBuilder.Entity("ProductCategories", b =>
                {
                    b.HasOne("LogisticsApp.Infrastructure.Persistence.Products.Entities.CategoryEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductColors", b =>
                {
                    b.HasOne("LogisticsApp.Infrastructure.Persistence.Products.Entities.ColorEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductSizes", b =>
                {
                    ...
                    b.HasOne("LogisticsApp.Infrastructure.Persistence.Products.Entities.SizeEntity", null)
                        .WithMany()
