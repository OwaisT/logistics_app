...
using LogisticsApp.Domain.BoundedContexts.Catalog.Aggregates.OrderReturn.ValueObjects;
using LogisticsApp.Domain.Common.Models;

namespace LogisticsApp.Domain.BoundedContexts.Catalog.Aggregates.OrderReturn;
